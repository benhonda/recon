      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        <div className="">
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            <div>
              ...
              <div className="mt-8 md:mt-0 md:order-1">
                <p className="text-left text-base text-gray-400">© 2020 Workflow, Inc. All rights reserved.</p>
              </div>
            </div>
          ...
          {/* <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 xl:text-center">© 2020 Workflow, Inc. All rights reserved.</p>
          </div> */}
          {/* <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-left text-base text-gray-400">© 2020 Workflow, Inc. All rights reserved.</p>
          </div> */}
